package com.jiagu.management.widget.progressbar;
...
/**
 * @ClassName: CircularProgressDrawable
 * @Description:
 * @author zz
 * @date 2015年1月15日 下午12:36:48
 * @version 1
...
public class CircularProgressDrawable extends Drawable implements Animatable {
	...
	/**
	 * 绘制圆弧臂长的动画，该动画受 mModeAppearing 控制�? �? mModeAppearing �? false
	 * 的时候，圆弧的起始点在增加，圆弧的终止点不变，弧长在逐渐减少�? �? mModeAppearing �? true 的时候，
	 * 圆弧的起始点不变，圆弧的终止点变大，弧长在�?�渐增加
	 */
