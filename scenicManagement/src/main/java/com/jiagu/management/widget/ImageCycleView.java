...
public class ImageCycleView extends LinearLayout {
	 ...
	 */
	public void setImageResources(ArrayList<String> imageInfoList, ImageCycleViewListener imageCycleViewListener) {
		// 清除所有子视图
		mGroup.removeAllViews();
		// 图片广告数量
		imageCount = imageInfoList.size();
		mAdvAdapter = new ImageCycleAdapter(mContext, imageInfoList, imageCycleViewListener);
		mAdvPager.setAdapter(mAdvAdapter);
		mAdvPager.setCurrentItem(400);
		startImageTimerTask();
	}
